...
<footer class="container-fluid row row-cols-1 row-cols-sm-2 row-cols-md-5 py-5 my-5 border-top">
  ...
  <div class="nav flex-column text-start">
    ...
    <img class="picto me-2" src="<?php echo get_template_directory_uri(); ?>/assets/img/Pictogrammes/letter.svg" alt="Flèche">
      ...
      <a class="items-footer" href="mailto:supway@gmail.com">
      supway@gmail.com
        </a>
      </p>
    </div>
  ...
  <div class="nav flex-column text-start">
    ...
    <div class="d-flex align-items-center mb-3">
      ...
      <p class="nav-item mb-0 liens-footer">
        <a href="<?php echo esc_url(get_permalink(get_page_by_path('/sinscrire'))); ?>" class="nav-link p-0 items-footer">
          S'inscrire
        </a>
      </p>
    </div>
...
<div class="col mb-3 d-flex justify-content-center mx-auto align-items-center ">
      ...
      <ul class="nav flex-column liens-footer">
        <li class="nav-item mb-2 "><a href="<?php echo esc_url(get_permalink(get_page_by_path('/mentions-legales'))); ?>" class="nav-link p-0 items-footer">Mentions légales</a></li>
        
        
      </ul>
    </div>
  <div class="col mb-3 d-flex justify-content-center align-items-center mentions-legales">
