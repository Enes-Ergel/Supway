...
<div class="container">
  <div class="row">
    <div class="col-12 col-lg-12">
      <h2 class="nosobjectifs">Nos objectifs</h2>
    </div>
  </div>
  <div class="row">
  <div class="cards">
    <div class="col-12 col-md-6 col-lg-4">
      <div class="card">
        <p>Orienter les jeunes avec un quiz personnalisé qui recommande des filières et formations adaptées à leur profil.</p>
        <div class="picto">
          <img src="<?php echo get_template_directory_uri(); ?>/assets/img/Pictogrammes/graph.svg">
        </div>
    </div>
    </div>
    <div class="col-12 col-md-6 col-lg-4">
      <div class="card">
        <p>Offrir une aide individuelle à chaque étudiant(e) avec des conseillers prêts à les guider au mieux.</p>
        <div class="picto">
          <img src="<?php echo get_template_directory_uri(); ?>/assets/img/Pictogrammes/question.svg">
      </div>
    </div>
    </div>
    <div class="col-12 col-md-6 col-lg-4">
      <div class="card">
        <p>Créer une communauté d’étudiants qui partagent leurs expériences pour inspirer autrui.</p>
        <div class="picto">
          <img src="<?php echo get_template_directory_uri(); ?>/assets/img/Pictogrammes/community.svg">
        </div>
      </div>
  </div>
</div>
