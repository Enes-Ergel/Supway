...
<div class="row pt-5 ps-5">
  <div class="col-12 col-lg-6 rubrique3">
      <h2 class="titre-rubrique3 ms-lg-5 mb-4" >Partagez votre expérience, ...</h2>
      <div class="corps-texte ms-lg-5">
  ...
  <div class="col-12 col-lg-6">
    <img class="img-fluid ms-lg-5 mb-5" src="<?php echo get_template_directory_uri(); ?>/assets/img/student-with-smartphone 1.svg">
  </div>
</div>
</div>
<div class="container-fluid">
...
<img class="img-fluid ms-lg-5 mb-5" src="<?php echo get_template_directory_uri(); ?>/assets/img/conseiller-avec-pc.svg">
</div>
...
<p class="corps-texte ms-lg-5">Avec votre expertise, guidez la nouvelle génération dans leurs choix d'études et démarches. 
  Faites la différence dès aujoud'hui en devenant un acteur clé de leur réussite !</p>
</div>
</div>
</div>
</section>
